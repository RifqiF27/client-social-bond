...
<header>
  ...
  <nav id="main-navbar" class="navbar navbar-expand-lg navbar-light bg-white fixed-top">
    ...
    <div class="container-fluid">
      ...
      <div class="d-none d-md-flex justify-content-center mx-auto w-auto my-auto">
      ...
      <ul class="navbar-nav d-flex align-items-center flex-row">
        ...
        <li class="nav-item me-3">
          <a @click="$router.push('/msg')" class="nav-link py-1" href="#" data-mdb-toggle="tooltip" title="">
            <i class="fa-brands fa-rocketchat"></i>
          </a>
        </li>
        <li class="nav-item me-3">
          <a class="nav-link py-1" href="#" data-mdb-toggle="tooltip" title="">
            <i class="fas fa-user-circle fa-fw me-3"></i>{{username}}
          </a>
        </li>

        <!-- Avatar -->
        <li class="nav-item dropdown">
          <a  @click="doLogout()" class="nav-item nav-link dropdown-toggle user-action hidden-arrow d-flex align-items-center py-1"
            id="navbarDropdownMenuLink" role="button" data-mdb-toggle="dropdown" aria-expanded="false" data-toggle="dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownMenuLink"
            ...
            <li>
              <div class="px-3 pt-3 d-flex">
                ...
                <div>
                  ...
                  <a class="mb-0" href="https://myaccount.google.com">Manage your Google Account</a>
                </div>
              </div>
              <hr class="mb-2">
            </li>
            ...
            <li><a @click="doLogout()" class="dropdown-item" href="#"><i class="fas fa-sign-out-alt me-3"></i><span>Sign out</span></a>
            </li>
            <!-- <hr class="my-2">
...
export default {
  ...
  computed: {
    ...mapWritableState(useCounterStore, ['username', 'email'])
  },
  created() {
